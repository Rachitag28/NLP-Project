...
atheism_tweets=tweets[513:907]
atheism_sentiments=sentiments[513:907]
atheism_stances=stances[513:907]
atheism_hashtags=hashtags[513:907]
...
atheism_tweets_test=tweets_test[220:388]
atheism_sentiments_test=sentiments_test[220:388]
atheism_stances_test=stances_test[220:388]
atheism_hashtags_test=hashtags_test[220:388]
...
asentiments=[float(i) for i in atheism_sentiments]
asentiments=[int(i) for i in atheism_sentiments]
sentiments=[(i-min(asentiments))/(max(asentiments)-min(asentiments)) for i in asentiments]
...
training_features=all_features[:394]
training_stances=atheism_stances[:394]
testing_features=all_features[395:]
testing_stances=atheism_stances[395:]
